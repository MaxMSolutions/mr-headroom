...
(function() {
  this.Dosbox = (function() {
    ...
    Dosbox.prototype._jsdos_init = function(module, script, onload) {
      ...
      // Add Sound Blaster environment configuration before eval
      // This ensures the Sound Blaster environment variable is set before DOS boots
      var soundBlasterConfig = 
        'if (!Module.preRun) Module.preRun = [];\n' +
        'Module.preRun.push(function() {\n' +
        '  ENV = ENV || {};\n' +
        '  ENV.BLASTER = "A220 I7 D1 H5 T6";\n' +
        '  ENV.PATH = "Z:\\\\;C:\\\\";\n' +
        '  console.log("Sound Blaster environment configured");\n' +
        '});\n';
      
      // Insert our configuration before executing the script
      script = soundBlasterConfig + script;
